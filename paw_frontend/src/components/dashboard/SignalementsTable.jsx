        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-beige-200">
              <th className="text-left px-6 py-3.5 text-[11px] font-semibold text-taupe-400 uppercase tracking-wider">Type</th>
              <th className="text-left px-6 py-3.5 text-[11px] font-semibold text-taupe-400 uppercase tracking-wider">Localisation</th>
              <th className="text-left px-6 py-3.5 text-[11px] font-semibold text-taupe-400 uppercase tracking-wider">Date</th>
              <th className="text-left px-6 py-3.5 text-[11px] font-semibold text-taupe-400 uppercase tracking-wider">Statut</th>
            </tr>
          </thead>
          <tbody>
            {signalements.map((s) => {
                ...
                <tr key={s.id} className="border-b border-beige-200 last:border-0 hover:bg-beige-50/50 transition-colors">
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 bg-beige-100 rounded-lg flex items-center justify-center">
                        <Icon size={16} strokeWidth={1.5} className="text-taupe-600" />
                      </div>
                      <div>
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-1.5 text-sm text-taupe-600">
                      ...
                      {s.territoire_name || s.adresse_approximative}
                    </div>
                  </td>
                  <td className="px-6 py-4 text-sm text-taupe-400">
